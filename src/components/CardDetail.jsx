const CardDetail = ( { description, location } ) => {
  
  const styles = {
    row: "capitalize leading-loose border-gray-200 border-b py-2 flex justify-between px-4",
    title: "font-semibold text-5xl text-gray-700",
  }

  return (
    <div className="flex flex-col rounded-md bg-white text-black overflow-hidden shadow-lg">
      <p className="p-3 font-semibold text-xl">El tiempo en {description.place}, {description.city} hoy</p>
      <div className="flex grid grid-cols-2 gap-5">
        <ul>
          <li>
            <div className="mx-6 flex flex-col p-4 h-28">
              <h1 className={styles.title}>{location.realFeelTemp}°</h1>
              <p>Sensación</p>
            </div>
          </li>
          <li className={styles.row}>
            <div className="flex">
              ...
              <p className="px-2">Máx./Min.</p>
            </div>
            <p>{location.maxTemp}°/{location.minTemp}°</p>
          </li>
          <li className={styles.row}>
            <div className="flex">
              <svg className="w-6" viewBox="0 0 24 24">
          ...
          <li className={styles.row}>
            ...
            <p className="px-2">Presión</p>
            </div>
            <p className="lowercase">{location.pressure}</p>
          </li>
        </ul>

        <ul>
          <li className="h-28">
            <div className="flex flex-row justify-end pt-4 mx-20">
              <svg version="1.1" width="64" height="44" xmlns="http://www.w3.org/2000/svg">
                <clipPath id="cut-off">
                  <rect x="0" y="0" width="64" height="40"/>
                </clipPath>
                <circle cx="32" cy="32" r="32" fill="#ffffff"/>
                <circle cx="32" cy="32" r="32" fill="#e19b22" clipPath="url(#cut-off)"/>
              </svg>
            </div>
            
            <div className="flex flex-row justify-end mx-10 pt-1">
              <div className="flex">
                <svg className="w-6" viewBox="0 0 24 24">
                  <title>Salida sol</title>
                  <path d="M10.862 6.052v5.329a.75.75 0 0 0 1.5 0V6.036l1.772 1.534a.75.75 0 0 0 .982-1.134l-3.003-2.601a.75.75 0 0 0-.982 0L8.128 6.436A.75.75 0 0 0 9.11 7.57l1.752-1.518zM21 19.128a.75.75 0 0 0 0-1.5H3.167a.75.75 0 1 0 0 1.5H21z" fill="#ffc21e"></path>
                </svg>
                <p className="px-1">{location.sunRise}</p>
              </div>
              <div className="flex">
                <svg className="w-6" viewBox="0 0 24 24">
                  <title>Puesta sol</title>
                  <path d="M10.862 9.853L9.044 8.278a.75.75 0 1 0-.982 1.134l3.003 2.602a.75.75 0 0 0 .982 0l3.004-2.602a.75.75 0 0 0-.983-1.134l-1.706 1.478V4a.75.75 0 0 0-1.5 0v5.853zM21 19.075a.75.75 0 1 0 0-1.5H3.167a.75.75 0 1 0 0 1.5H21z" fill="#ffc21e"></path>
                </svg>
                <p className="px-1">{location.sunSet}</p>
              </div>
            </div>
          </li>
